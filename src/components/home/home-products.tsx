    ...
    >
      ...
      <div className="grid max-w-7xl gap-6 md:grid-cols-3">
        ...
        <HomeProduct
          ...
          buttonLink="#"
        />
        <HomeProduct number={10} title="RWA Vaults" text="Coming soon" />
      </div>
    </div>
  );
};
  ...
  return (
    <div
      className={cn(
        ...
        "relative flex h-[466px] flex-col items-center justify-between overflow-hidden rounded-2xl border-2 border-[#2D2D2D] px-10 pb-8 pt-10 transition-all duration-1000 ease-in",
      )}
      style={{
